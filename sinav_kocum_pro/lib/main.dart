...
Future<void> main() async {
  ...
  runApp(const SinavKocumPro());
}

class SinavKocumPro extends StatelessWidget {
  const SinavKocumPro({super.key});
        ...
        return Scaffold(
          ...
          bottomNavigationBar: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF8A7D6B).withValues(alpha: 0.05),
                  blurRadius: 16,
