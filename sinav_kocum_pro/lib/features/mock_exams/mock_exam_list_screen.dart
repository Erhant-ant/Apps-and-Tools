...
class _MockExamCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String examTypeLabel = exam.examType.toUpperCase();
    if (exam.examType == 'kpss_lisans') {
      examTypeLabel = 'KPSS Lisans';
    } else if (exam.examType == 'ekpss') {
      examTypeLabel = 'E-KPSS';
    } else if (exam.examType == 'dgs') {
      examTypeLabel = 'DGS';
    } else if (exam.examType == 'ales') {
      examTypeLabel = 'ALES';
    } else if (exam.examType == 'tus') {
      examTypeLabel = 'TUS';
    } else if (exam.examType == 'tyt') {
      examTypeLabel = 'TYT';
    } else if (exam.examType == 'ayt') {
      examTypeLabel = 'AYT';
    } else if (exam.examType == 'ydt') {
      examTypeLabel = 'YDT';
    } else if (exam.examType == 'yds') {
      examTypeLabel = 'YDS';
    }
