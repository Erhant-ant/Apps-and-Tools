...
import '../tools/tools_bottom_sheet.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Merhaba ${appState.userName ?? 'Öğrenci'} 👋',
  ...
  Widget _buildMascotCard(AppState appState) {
    final message = appState.currentMascotMessage;
  ...
  Widget _buildCountdownCards(AppState appState) {
    if (appState.selectedExamIds.isEmpty) return const SizedBox.shrink();
    
    final exams = appState.selectedExamIds
        .map((id) => ExamDatabase.getExamById(id))
        .where((e) => e != null && e.examDate != null)
        .toList();
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          // Assign different gradients for visual variety if desired
          final gradients = [AppTheme.primaryGradient, AppTheme.kpssGradient, AppTheme.aytGradient, AppTheme.tytGradient];
